...
$fmsg2 = htmlspecialchars(getfmsg2());
  ...
  echo "<form action=\"headadminproc.php?action=general\" method=\"post\">";
...
boxstart("Add Perm");
    ...
    echo "<form action=\"headadminproc.php?action=addperm\" method=\"post\">";
...
boxstart("Mods");
    ...
    echo "<go href=\"headadminproc.php?action=addfmod\" method=\"post\">";
    ...
    */
    ...
    echo "<go href=\"headadminproc.php?action=delfmod\" method=\"post\">";
...
boxstart("Catagories");
    ...
    echo "<a href=\"headadmincp.php?action=addcat\">&#187;Add Category</a><br/>";

    echo "<a href=\"headadmincp.php?action=edtcat\">&#187;Edit Category</a><br/>";

    echo "<a href=\"headadmincp.php?action=delcat\">&#187;Delete Category</a><br/>";
...
boxstart("Clubs");
    ...
    echo "<a href=\"headadmincp.php?action=gccp&amp;clid=$clid\">&#187;Give Credit Plusses</a><br/>";

    echo "<a href=\"headadminproc.php?action=delclub&amp;clid=$clid\">&#187;Delete Club</a><br/>";
...
boxstart("Rss");
    ...
    echo "<a href=\"headadmincp.php?action=addrss\">&#187;Add Source</a><br/>";

    $noi = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM dcroxx_me_rss"));

    if($noi[0]>0)

    {echo "<form action=\"headadmincp.php?action=edtrss\" method=\"post\">";
...
echo "<form action=\"headadminproc.php?action=delrss\" method=\"post\">";
...
boxstart("Chatrooms");
    ...
    echo "<a href=\"headadmincp.php?action=addchr\">&#187;Add Room</a><br/>";
...

    {
        ...
        echo "<form action=\"headadminproc.php?action=delchr\" method=\"post\">";
...
{$pstyle = gettheme($sid);
    ...
    echo "<a href=\"headadmincp.php?action=addfrm\">&#187;Add Forum</a><br/>";

    echo "<a href=\"headadmincp.php?action=edtfrm\">&#187;Edit Forum</a><br/>";

    echo "<a href=\"headadmincp.php?action=delfrm\">&#187;Delete Forum</a><br/>";
...
boxstart("Clear Data");
    ...
    echo "<a href=\"headadminproc.php?action=delpms\">&#187;Deleted PMs</a><br/>";

    echo "<a href=\"headadminproc.php?action=clrmlog\">&#187;Clear ModLog</a><br/>";

    echo "<a href=\"headadminproc.php?action=delsht\">&#187;Delete Old Shouts</a><br/>";
...
boxstart("Groups");
    ...
    echo "<a href=\"headadmincp.php?action=addgrp\">&#187;Add User Group</a><br/>";

    //echo "<a href=\"headadmincp.php?action=edtgrp\">&#187;Edit User group</a><br/>";

    echo "<a href=\"headadmincp.php?action=delgrp\">&#187;Delete User group</a><br/>";
...
boxstart("Catagories");
    ...
    echo "<form action=\"headadminproc.php?action=addcat\" method=\"post\">";
...
{$pstyle = gettheme($sid);
  ...
  addonline(getuid_sid($sid),"headadmincp - xHTML:v3","");
...
echo "<td class=\"boxedContent\">";
	...
	echo "<form action=\"headadminproc.php?action=addfrm\" method=\"post\">\n";
...
boxstart("Plusses");
    ...
    echo "<form action=\"headadminproc.php?action=gccp&amp;clid=$clid\" method=\"post\">";
...

{
  ...
  echo "<b>9 </b><a accesskey=\"9\" href=\"headadmincp.php?action=headadmincp\"><img src=\"../images/admn.gif\" alt=\"\"/>headadminTools</a><br/>";
...

{
    ...
    echo "<form action=\"ownrproc.php?action=addsml\" method=\"post\">";
...
echo "<a href=\"smilies/index.php?action=upload&amp;script=xhtml&amp;prevscript=$script\">Upload</a><br/>";
  ...
  echo "<b>9 </b><a accesskey=\"9\" href=\"index.php?action=headadmincp\"><img src=\"../images/admn.gif\" alt=\"\"/>headadminTools</a><br/>";
...
boxstart("Avatar");
    ...
    echo "<form action=\"headadminproc.php?action=addavt\" method=\"post\">";
...
boxstart("Rss");
    ...
    echo "<form action=\"headadminproc.php?action=addrss\" method=\"post\">";
...
boxstart("Chat Room");
    ...
    echo "<form action=\"headadminproc.php?action=addchr\" method=\"post\">";
...
{$pstyle = gettheme($sid);
  ...
  $rsinfo = mysql_fetch_array(mysql_query("SELECT title, link, imgsrc, fid, dscr FROM dcroxx_me_rss WHERE id='".$rssid."'"));
    ...
    echo "<form action=\"headadminproc.php?action=edtrss\" method=\"post\">";
...
$pstyle = gettheme($sid);
    ...
    echo "<form action=\"headadminproc.php?action=addgrp\" method=\"post\">";
...
boxstart("Forum");
    ...
    echo "<form action=\"headadminproc.php?action=edtfrm\" method=\"post\">";
...
boxstart("Forum");
   ...
   echo "<form action=\"headadminproc.php?action=delfrm\" method=\"post\">";
...
boxstart("Group");
    ...
    echo "<form action=\"headadminproc.php?action=delgrp\" method=\"post\">";
...
boxstart("Catagories");
    ...
    echo "<form action=\"headadminproc.php?action=edtcat\" method=\"post\">";
...
{boxstart("Catagories");
    ...
    echo "<form action=\"headadminproc.php?action=delcat\" method=\"post\"/>";
...
boxstart("Change User Info");
...

    {
      ...
      echo "<a href=\"headadmincp.php?action=chubi&amp;who=$tid\">&#187;$unick's Profile</a><br/>";
      ...
      echo "<a href=\"headadminproc.php?action=deljdg&amp;who=$tid\">&#187;Remove $unick From Judges List</a><br/>";

      }else{

        echo "<a href=\"headadminproc.php?action=addjdg&amp;who=$tid\">&#187;Make $unick judge</a><br/>";

      }

      //echo "<a href=\"headadmincp.php?action=addtog&amp;who=$tid\">&#187;Add  $unick to a group</a><br/>";

      //echo "<a href=\"headadmincp.php?action=umset&amp;who=$tid\">&#187;$unick's Mod. Settings</a><br/>";

	  echo "<a href=\"headadminproc.php?action=delxp&amp;who=$tid\">&#187;Delete $unick's posts</a><br/>";

      echo "<a href=\"headadminproc.php?action=delu&amp;who=$tid\">&#187;Delete $unick</a><br/>";
...
echo "<a href=\"lists.php?action=readmsgs&amp;who=$tid\">&#187;Read Send Messages</a><br/>";
 ...
 echo "<br/><br/>";
	...
	echo "<form action=\"headadminproc.php?action=upwd&amp;who=$who\" method=\"post\">\n";
    ...
    echo "<a href=\"headadmincp.php?action=chuinfo\">";
