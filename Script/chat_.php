  ...
  echo xhtmlfoot();
    ...
    addtochat($uid, $rid);
      ...
      if ($action=="")
        ...
        $pstyle = gettheme($sid);
        echo xhtmlheadchat2("Chat",$pstyle,$rid,$sid);
        
       //echo "<meta http-equiv=\"refresh\" content=\"0; url=chat.php?time=";
      //echo "".date("dmHis")."";
      //echo "&amp;rid=$rid&amp;rpw=$rpw\">";
         
        echo "<timer value=\"44\"/><p align=\"center\">";
        addonline($uid,"Chatrooms","");
        echo "<small>
        <a href=\"chat.php?action=say&amp;rid=$rid&amp;rpw=$rpw\">Options</a> / ";
        $time = date('dmHis');
        echo "<a href=\"chat.php?time=$time&amp;rid=$rid&amp;rpw=$rpw\">Refresh</a>";
      ...
      echo "</small></p>";
        ...
        if (trim($message) != "")
        {
          $nosm = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM dcroxx_me_chat WHERE msgtext='".$who."'"));
          if($nosm[0]==0){
          ...
          $message = "";
            ...
            while($chat = mysql_fetch_array($chats))
            {
                ...
                if(($cmid[0]!=0))
                {
                  ...
                  echo "<a href=\"chat.php?action=say2&amp;who=$chat[0]&amp;rid=$rid&amp;rpw=$rpw\">$optlink</a>&#187;";
                  echo $tosay."<br/>";
                  }
                }
        ...
        echo "<p align=\"center\">";
            ...
            echo "<form action=\"chat.php?rid=$rid&amp;rpw=$rpw\" method=\"post\">";
      ...
      echo xhtmlheadchat("",$pstyle);
        ...
        addonline($uid,"Writing Chat Message","");
           ...
           // echo "<form action=\"chat.php?sid=$sid&amp;rid=$rid&amp;rpw=$rpw\" method=\"post\">";
            ...
            echo "<small><a href=\"chat.php?rid=$rid&amp;rpw=$rpw\">&#171;Chatroom</a></small></p>";
        //end
...
///////////////////////////////////////////////inside//////////
      ...
      echo xhtmlheadchat("Inside List",$pstyle);
       ...
       // echo "<a href=\"chat.php?sid=$sid&amp;rid=$rid&amp;rpw=$rpw\">&#171;Chatroom</a><br/>";
        echo "<a href=\"chat.php?rid=$rid&amp;rpw=$rpw\">&#171;Chatroom</a><br/>";
