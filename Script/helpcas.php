...
if (!$bcon)
{
  $pstyle = gettheme($sid);
    ...
    echo "you can temperoray be in this site <a href=\"http://$stitle.tk/chat\">$site_name</a> while $site_name is offline<br/>";
...
if($action=="main")
 ...
 addonline(getuid_sid($sid),"personal Gallery","");
   $pstyle = gettheme($sid);
	  ...
	  echo "<small><b>[7][7][7]</b>- Win 100+ Credits!</small><br/>";
echo "<small><b>[3][3][3]</b>- Win 30+ Credits!</small><br/>";
echo "<small><b>[*][7][7]</b>- Win 10+ Credits!</small><br/>";
echo "<small><b>[*][*][7]</b>- Win 5+ Credits</small><br/>";
echo "<small><b>[1][1][1]</b>- lose 80+ Credits</small><br/>";
echo "<small><b>[*][1][1]</b>- lose 20+ Credits</small><br/>";
echo "<small><b>[*][*][1]</b>- lose 3 Credits</small><br/>";
echo "<small>(<b>!</b>)Win more Credits and unlock much features in $stitle! <br/><br/> if you cannot refresh clicking SPIN THE WHEEL BUTTON try other way ( clear ur 4n cache, page reload. etc..),have fun!!</small><br/>----------<br/>";
echo "&#171;<small><a href=\"lists.php?action=casino\">back</a></small><br/>";
